...
max = (1..1_000_000_000_000).bsearch do |i|
  reagents = fuel_reaction.reagents.map {|k,v| [k, i*v]}.to_h
  new_reaction = Reaction.new(fuel_reaction.name, fuel_reaction.amount * i, reagents)

  new_reaction.breakdown_reagents(reactions, {})

  new_reaction.reagents["ORE"] > 1_000_000_000_000
end
puts max - 1
